...
const FAQS = [
  {
    ...
    a: 'সহবাসের ২-৩ মিনিট আগে পরিষ্কার করে শুকিয়ে নিন, টিস্যু দিয়ে আগা থেকে মাঝ পর্যন্ত ২-৩ বার মুছুন এবং ২ মিনিট অপেক্ষা করুন।',
  },
  {
    q: 'এটা কি অরিজিনাল প্রোডাক্ট?',
    a: 'হ্যাঁ, ম্যাজিক টিস্যু ১০০% অরিজিনাল জার্মান প্রোডাক্ট। প্রতিটি প্যাকেট সিলড অবস্থায় ডেলিভারি দেওয়া হয়।',
  },
  {
    q: 'কোনো সাইড ইফেক্ট আছে কি?',
    a: 'না, ম্যাজিক টিস্যু ভিটামিন E সমৃদ্ধ এবং জার্মান ল্যাব টেস্টেড। ডায়াবেটিস ও হার্টের রোগীরাও নিরাপদে ব্যবহার করতে পারেন।',
  },
  {
    q: 'ডেলিভারি কতদিনে পাব?',
    a: 'অর্ডার করার ২৪-৭২ ঘণ্টার মধ্যে আপনার ঠিকানায় ডেলিভারি পৌঁছে যাবে।',
  },
  {
    q: 'পেমেন্ট কিভাবে করব?',
    a: 'ক্যাশ অন ডেলিভারি — পণ্যটি হাতে পেয়ে চেক করে পেমেন্ট করুন। কোনো অগ্রিম পেমেন্ট লাগবে না।',
  },
  {
    q: 'অর্ডার কিভাবে করব?',
    a: 'কল করুন 01336-580900 নম্বরে অথবা WhatsApp / Facebook-এ মেসেজ দিন। আমাদের প্রতিনিধি অর্ডার কনফার্ম করবেন।',
  },
];
